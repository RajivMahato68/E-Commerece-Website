...
if (isset($_GET['edit_products'])) {
    ...
    if ($result) {
        ...
        if ($row) {
            ...
            $categories_title = isset($row_category['categories_title']) ? $row_category['categories_title'] : '';
...
if(isset($_POST['edit_product'])){
    ...
    //checking for fill empty or not
    ...
    //     echo "<script>alert('please fill all the field and continuous the process')</script>";
    // }else{
        move_uploaded_file($temp_image1,"./product_images/$product_image1");
        move_uploaded_file($temp_image2,"./product_images/$product_image2");
        move_uploaded_file($temp_image3,"./product_images/$product_image3");

        //query to update oroducts
        $update_product = "UPDATE `products` SET product_title='$product_title', product_description='$product_desc', product_image1='$product_image1', product_image2='$product_image2', product_image3='$product_image3', product_price='$product_price', date=NOW() WHERE product_id=$edit_id";
